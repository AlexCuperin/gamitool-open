...
CREATE TABLE gamification_design_access(
  id              serial,
  user_id bigint unsigned NOT NULL,
  gamification_id bigint unsigned NOT NULL,
...
CREATE TABLE gamification_engines(
  ...
  gdesign_id bigint unsigned NOT NULL,
...
CREATE TABLE resource_rr(
  ...
  rr_type_id bigint unsigned NOT NULL
);
...
CREATE TABLE actions(
  id          serial,
  res_cond_id bigint unsigned  NOT NULL,
  type_id bigint unsigned  NOT NULL,
...
CREATE TABLE gamification_deploys(
  id                serial,
  gdesign_id        bigint unsigned NOT NULL,
  instance_type_id  bigint unsigned NOT NULL,
...
CREATE TABLE students(
  id                serial,
  gdeploy_id        bigint unsigned NOT NULL,
