<!--Footer-->
    <footer class="page-footer center-on-small-only elegant-color-dark" style="margin:0; padding:0">
    {{--
    <!--Footer Links-->
...
<div class="footer-copyright">
    <div class="container-fluid">
        © 2021 Copyright. <a href="https://www.gsic.uva.es/index.php?lang=en"> GSIC-EMIC Research Group </a>
