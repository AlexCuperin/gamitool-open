...
<body>
    ...
    <!--Intro Section-->
    <section style="position: inherit; min-height: 100%; background: url({{ asset('img/background_gam.png') }})center center;">
        <div class="full-bg-img">
            <div class="container">
                <div class="divider-new pt-5" style="margin-bottom: 20px;">
                ...
                {{--@include('teachers.lite.pills',          ['targetclass'=>'reports', 'targetid'=>'report'])--}}
