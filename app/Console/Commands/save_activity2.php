...
class save_activity2 extends Command{
    /**
     * The name and signature of the console command.
     * @var string
     */
    protected $signature = 'activities:2_quizmaster';

    /**
     * The console command description.
     * @var string
     */
    protected $description = 'Check if QUIZMASTER activity was fulfilled and save the data for every student';
    ...
    public function handle(){
        ...
        // We need the submissions of the quizes 0 and 1
        $quiz0_submissions = $canvas->get_quizsubmissions(0);
        $quiz1_submissions = $canvas->get_quizsubmissions(1);
        ...
        foreach ($students as $u){
            ...
            if(!$u->activities || !$u->activities->reward_2){

                /* SAVE REWARD 2
                 * @param1: obj quiz0
                 * @param2: obj quiz1
                 */
                $date = $u->check_reward_2($canvas->filter_submissions($quiz0_submissions),
                                           $canvas->filter_submissions($quiz1_submissions));
