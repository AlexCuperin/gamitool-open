...
class save_activity4 extends Command{
    /**
     * The name and signature of the console command.
     * @var string
     */
    protected $signature = 'activities:4_textprovider';

    /**
     * The console command description.
     * @var string
     */
    protected $description = 'Check if TEXTPROVIDER activity was fulfilled and save the data for every student';
    ...
    public function handle(){
        ...
        // We need the forum to check the reward 4
        $forum = $canvas->get_forum_partext();
        ...
        foreach ($students as $u){
            ...
            if(!$u->activities || !$u->activities->reward_4){

                /* SAVE REWARD 4
                 * @param1: obj forum
                 */
                $date = $u->save_reward_4($forum);
